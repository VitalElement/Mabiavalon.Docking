...
namespace Mabiavalon.Core
{
    internal static class Native
    {
        ...
        public static Point ToPerspex(this Point pixelPoint)
        {
            ...
            var perspexPoint = new Point(physicalUnitSize * pixelPoint.X, physicalUnitSize * pixelPoint.Y);
        ...
        public static IEnumerable<Window> SortWindowsTopToBottom(IEnumerable<Window> windows)
        {
            ...
            {
                var topLevel = window.GetVisualAncestors().OfType<TopLevel>().FirstOrDefault();
                var handle = topLevel != null ? topLevel.PlatformImpl.Handle.Handle : IntPtr.Zero;
